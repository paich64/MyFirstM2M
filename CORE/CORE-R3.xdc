...
create_generated_clock -name vga_clk       [get_pins M2M/i_framework/i_clk_m2m/i_clk_vga/CLKOUT0]
...
set_false_path -from [get_clocks qnice_clk]    -to [get_clocks vga_clk]
